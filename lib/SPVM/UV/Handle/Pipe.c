...
static const char* FILE_NAME = "UV/Handle/Pipe.c";

int32_t SPVM__UV__Handle__Pipe__new(SPVM_ENV* env, SPVM_VALUE* stack) {
  ...
  SPVM_OBJ* obj_uv_pipe = env->new_pointer_object_by_name(env, stack, "UV::Handle::Pipe", uv_pipe, &error_id, __func__, FILE_NAME, __LINE__);
...
int32_t SPVM__UV__Handle__Pipe__open(SPVM_ENV* env, SPVM_VALUE* stack) {
