...
SPVM::UV::Request::Write - Write Request for libuv

=head1 Description

C<UV::Request::Write> in L<SPVM> represents the write request for L<libuv|https://libuv.org/>, corresponding to the C<uv_write_t> structure. 

=head1 Usage

  use UV::Request::Write;
  
  my $req_write = UV::Request::Write->new;

=head1 Super Class

L<UV::Request|SPVM::UV::Request>.

=head1 Fields

=head2 write_cb

C<has write_cb : rw L<UV::Callback::Write|SPVM::UV::Callback::Write>;>
...
C<static method new : L<UV::Request::Write|SPVM::UV::Request::Write> ();>

Creates a new L<UV::Request::Write|SPVM::UV::Request::Write> object, and returns it.

=head1 Instance Methods

=head2 write

C<method write : void ($uv_stream : L<UV::Handle::Stream|SPVM::UV::Handle::Stream>, $buffer : string, $buffer_length : int, $cb : L<UV::Callback::Write|SPVM::UV::Callback::Write>, $buffer_offset : int = 0);>
